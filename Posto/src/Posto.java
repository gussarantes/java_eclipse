...
public class Posto {
	public static void main(String[] args) {
		...
		Bomba lista[];  // é o equivalente a ter BombaDeCombustivel b1, b2, b3...;
		
		lista = new Bomba[4]; // acabei de criar um vetor de tamanho 4 do tipo BombaDeCombustivel
		...
		lista[0] = new Bomba("Etanol", 2.799);
		lista[1] = new Bomba("Gasolina Comum", 3.999);
		lista[2] = new Bomba("Gasolina Aditivada", 4.199);
		lista[3] = new Bomba("Diesel", 2.999);
